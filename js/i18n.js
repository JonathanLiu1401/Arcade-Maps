  ...
  var STRINGS = {
    en: {
      ...
      settings: {
        ...
        carto_basemap: "CARTO Voyager basemap",
        carto_basemap_desc: "Light CARTO tiles. OpenStreetMap is used automatically if CARTO cannot load.",
        ...
        color_note: "A store with several games takes the colour of the first selected game it has, in the order below. Counted-tier samples above share one colour so you can read the SHAPE. The ? sample uses the Other colour, which is what unlisted titles (デレステ and the rest of the catch-all) draw on the map. Named games tint their own icons.",
        ...
        osm_note: "Map data (c) OpenStreetMap contributors, ODbL. Basemap tiles by CARTO (Voyager), with OpenStreetMap tiles as fallback. Store listings belong to their respective sources and are aggregated here for convenience. Chinese coordinates are converted from GCJ-02 and are approximate.",
    ...
    "zh-Hans": {
      ...
      settings: {
        ...
        carto_basemap: "CARTO Voyager 底图",
        carto_basemap_desc: "浅色 CARTO 瓦片。若 CARTO 无法加载，则自动改用 OpenStreetMap。",
        location_head: "定位",
        ...
        osm_note: "地图数据 (c) OpenStreetMap 贡献者，ODbL。底图由 CARTO（Voyager）提供，OpenStreetMap 为备用。门店列表归各自来源所有，此处仅为汇总。中国坐标由 GCJ-02 转换，为近似值。",
    ...
    "zh-Hant": {
      ...
      settings: {
        ...
        carto_basemap: "CARTO Voyager 底圖",
        carto_basemap_desc: "淺色 CARTO 圖磚。若 CARTO 無法載入，則自動改用 OpenStreetMap。",
        location_head: "定位",
        ...
        osm_note: "地圖資料 (c) OpenStreetMap 貢獻者，ODbL。底圖由 CARTO（Voyager）提供，OpenStreetMap 為備用。店家列表歸各自來源所有，此處僅為彙總。中國座標由 GCJ-02 轉換，為近似值。",
    ...
    ja: {
      ...
      settings: {
        ...
        carto_basemap: "CARTO Voyager ベースマップ",
        carto_basemap_desc: "明るい CARTO タイル。CARTO が読めないときは OpenStreetMap に切り替えます。",
        location_head: "位置情報",
        ...
        color_note: "複数ゲームの店舗は下の順で最初に選択されたゲームの色。台数ありの凡例は形を示すための共通色。? は Other（デレステなど未分類）と同じ色で、地図上の該当ピンと揃えています。名前付きゲームはそれぞれの色です。",
        badges: "店舗ポップアップのバッジ",
        ...
        osm_note: "地図データ (c) OpenStreetMap 貢献者、ODbL。ベースマップは CARTO（Voyager）、失敗時は OpenStreetMap。店舗リストは各ソースに帰属し、ここは集約です。中国座標は GCJ-02 から変換した概算です。",
    ...
    ko: {
      ...
      settings: {
        ...
        carto_basemap: "CARTO Voyager 배경 지도",
        carto_basemap_desc: "밝은 CARTO 타일. CARTO를 불러오지 못하면 OpenStreetMap을 씁니다.",
        location_head: "위치",
        ...
        osm_note: "지도 데이터 (c) OpenStreetMap 기여자, ODbL. 배경 지도는 CARTO(Voyager), 실패 시 OpenStreetMap. 매장 목록은 각 출처 소유이며 여기선 집계입니다. 중국 좌표는 GCJ-02 변환 근사치입니다.",
    ...
    id: {
      ...
      settings: {
        ...
        carto_basemap: "Peta dasar CARTO Voyager",
        carto_basemap_desc: "Tile CARTO terang. OpenStreetMap dipakai otomatis jika CARTO gagal dimuat.",
        ...
        osm_note: "Data peta (c) kontributor OpenStreetMap, ODbL. Tile peta dasar oleh CARTO (Voyager), OpenStreetMap sebagai cadangan. Daftar toko milik sumber masing-masing. Koordinat China dikonversi dari GCJ-02 (perkiraan).",
    ...
    ms: {
      ...
      settings: {
        ...
        carto_basemap: "Peta asas CARTO Voyager",
        carto_basemap_desc: "Jubin CARTO cerah. OpenStreetMap digunakan secara automatik jika CARTO gagal dimuatkan.",
        location_head: "Lokasi",
        ...
        osm_note: "Data peta (c) penyumbang OpenStreetMap, ODbL. Jubin peta asas oleh CARTO (Voyager), OpenStreetMap sebagai sandaran. Senarai kedai milik sumber masing-masing. Koordinat China ditukar dari GCJ-02 (anggaran).",
    ...
    th: {
      ...
      settings: {
        ...
        carto_basemap: "แผนที่พื้น CARTO Voyager",
        carto_basemap_desc: "ไทล์ CARTO สีอ่อน ใช้ OpenStreetMap อัตโนมัติถ้าโหลด CARTO ไม่ได้",
        ...
        osm_note: "ข้อมูลแผนที่ (c) ผู้มีส่วนร่วม OpenStreetMap, ODbL พื้นแผนที่โดย CARTO (Voyager) สำรองเป็น OpenStreetMap รายการร้านเป็นของแหล่งต้นทาง พิกัดจีนแปลงจาก GCJ-02 (โดยประมาณ)",
      ...
      cabs: {
        ...
        badge_gitadora_gf_arena: "GF Arena",
        badge_gitadora_dm_arena: "DM Arena",
        badge_taiko_asia: "เอเชีย",
        badge_taiko_jp: "JP",
        badge_taiko_us: "สหรัฐ",
        taiko_asia: "Nijiiro - Asia build",
        taiko_jp: "Nijiiro - Japan build",
        taiko_us: "Nijiiro - USA build",
        gitadora_gf_arena: "GuitarFreaks Arena",
    ...
    vi: {
      ...
      settings: {
        ...
        carto_basemap: "Bản đồ nền CARTO Voyager",
        carto_basemap_desc: "Ô CARTO sáng. Dùng OpenStreetMap tự động nếu CARTO không tải được.",
        ...
        osm_note: "Dữ liệu bản đồ (c) cộng tác viên OpenStreetMap, ODbL. Ô bản đồ nền do CARTO (Voyager), OpenStreetMap khi dự phòng. Danh sách cửa hàng thuộc nguồn tương ứng. Tọa độ Trung Quốc chuyển từ GCJ-02 (xấp xỉ).",
    ...
    fil: {
      ...
      settings: {
        ...
        carto_basemap: "CARTO Voyager basemap",
        carto_basemap_desc: "Light CARTO tiles. Automatic na OpenStreetMap kung hindi mag-load ang CARTO.",
        ...
        osm_note: "Map data (c) OpenStreetMap contributors, ODbL. Basemap tiles by CARTO (Voyager), OpenStreetMap as fallback. Pag-aari ng kani-kanilang sources ang store listings. China coordinates mula sa GCJ-02 (tinatayang).",
    ...
    es: {
      ...
      settings: {
        ...
        carto_basemap: "Mapa base CARTO Voyager",
        carto_basemap_desc: "Teselas claras de CARTO. Se usa OpenStreetMap automáticamente si CARTO no carga.",
        ...
        osm_note: "Datos del mapa (c) colaboradores de OpenStreetMap, ODbL. Teselas de mapa base de CARTO (Voyager), OpenStreetMap como reserva. Los listados pertenecen a sus fuentes. Coordenadas de China convertidas desde GCJ-02 (aproximadas).",
      ...
      cabs: {
        ...
        badge_sdvx_vm: "Valkyrie",
        badge_sdvx_nemsys: "NEMSYS",
        badge_ddr_gold: "Cabina oro",
        badge_ddr_universal: "Universal",
        badge_ddr_legacy: "Legacy CRT",
        badge_popn_pikapika: "Pikapika",
        badge_gitadora_gf_arena: "GF Arena",
        badge_gitadora_dm_arena: "DM Arena",
        badge_taiko_asia: "Asia",
        badge_taiko_jp: "JP",
        badge_taiko_us: "EE.UU.",
        taiko_asia: "Nijiiro - Asia build",
        taiko_jp: "Nijiiro - Japan build",
        taiko_us: "Nijiiro - USA build",
        gitadora_gf_arena: "GuitarFreaks Arena",
    ...
    fr: {
      ...
      settings: {
        ...
        carto_basemap: "Fond de carte CARTO Voyager",
        carto_basemap_desc: "Tuiles CARTO claires. OpenStreetMap est utilisé automatiquement si CARTO ne charge pas.",
        ...
        osm_note: "Données cartographiques (c) contributeurs OpenStreetMap, ODbL. Tuiles de fond par CARTO (Voyager), OpenStreetMap en secours. Listes de salles appartiennent à leurs sources. Coordonnées chinoises converties depuis GCJ-02 (approximatives).",
    ...
    de: {
      ...
      settings: {
        ...
        carto_basemap: "CARTO-Voyager-Basiskarte",
        carto_basemap_desc: "Helle CARTO-Kacheln. OpenStreetMap wird automatisch genutzt, wenn CARTO nicht lädt.",
        ...
        osm_note: "Kartendaten (c) OpenStreetMap-Mitwirkende, ODbL. Basiskarten-Kacheln von CARTO (Voyager), OpenStreetMap als Fallback. Store-Listen gehören den jeweiligen Quellen. China-Koordinaten aus GCJ-02 (ungefähr).",
    ...
    pt: {
      ...
      settings: {
        ...
        carto_basemap: "Mapa-base CARTO Voyager",
        carto_basemap_desc: "Tiles claras da CARTO. OpenStreetMap é usado automaticamente se a CARTO não carregar.",
        ...
        osm_note: "Dados do mapa (c) contribuidores OpenStreetMap, ODbL. Tiles do mapa-base pela CARTO (Voyager), OpenStreetMap como reserva. Listagens pertencem às fontes. Coordenadas da China convertidas de GCJ-02 (aproximadas).",
    ...
    it: {
      ...
      settings: {
        ...
        carto_basemap: "Mappa di base CARTO Voyager",
        carto_basemap_desc: "Tessere CARTO chiare. OpenStreetMap si usa automaticamente se CARTO non carica.",
        ...
        osm_note: "Dati mappa (c) contributori OpenStreetMap, ODbL. Tessere della mappa di base di CARTO (Voyager), OpenStreetMap come riserva. Gli elenchi appartengono alle rispettive fonti. Coordinate Cina convertite da GCJ-02 (approssimative).",
    ...
    ru: {
      ...
      settings: {
        ...
        carto_basemap: "Подложка CARTO Voyager",
        carto_basemap_desc: "Светлые тайлы CARTO. OpenStreetMap подключается автоматически, если CARTO не загружается.",
        ...
        osm_note: "Данные карты (c) участники OpenStreetMap, ODbL. Тайлы подложки CARTO (Voyager), OpenStreetMap как запасной вариант. Списки залов принадлежат источникам. Координаты Китая переведены из GCJ-02 (приблизительно).",
