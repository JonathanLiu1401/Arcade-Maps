  ...
  var STRINGS = {
    en: {
      ...
      settings: {
        ...
        color_note: "A store with several games takes the colour of the first selected game it has, in the order below. Shape samples in the legend use that same first-selected colour, so 1-2 cab, multi-cab and ? icons match the map. Filter to one game to see every pin and every legend icon in one tint.",
    ...
    ja: {
      ...
      settings: {
        ...
        color_note: "複数ゲームの店舗は下の順で最初に選択されたゲームの色。凡例の形（1-2台・複数台・?）も同じ色なので、地図のピンと揃います。1つのゲームだけ選ぶと凡例もピンもその色だけになります。",
        badges: "店舗ポップアップのバッジ",
