...
(function (AM) {
  ...
  var TIER_CLASSES = [
    ...
    /* T3 is the five-point star. Owner asked 1.2x of the original 26px
       (31). T4/T5 stay at their original sizes. */
    { id: "3", min: 10, max: 19,       px: 31, short: "10-19", label: "10 to 19 cabinets" },
