...
At the last rebuild this affected **5,721 of 6,516 China entries** (`approx: true`). About 621 China entries have real (non-approx) coordinates, and 174 remain coordinate-less because no city key could be resolved. Taiwan is never approximated from this table (no Taiwan centroids; ZIv covers Taiwan with community pins).
