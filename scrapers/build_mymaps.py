...
per layer). Layers with more than 2000 features are split into _a/_b
parts (MyMaps hard limit is 2000 features per layer).
...
china_all_addresses.csv lists ALL China entries, even coordinate-less.
"""
...
def run(data_dir, out_dir):
    ...
    for layer in LAYERS:
        ...
        print("%-40s %5d members (%d without coords -> CSV only), %d part(s)"
              ...
              file=sys.stderr)
    # china_all_addresses.csv: every China entry, coordinate-less included
