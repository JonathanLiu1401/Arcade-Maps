...
24px (T3's star is 31px), and it reuses T2's button-pad silhouette with a "?" in
...
| --- | --- | --- | --- | --- | --- | --- |
| **Compact** z <= 10 | 16 | 19 | 25 | 20 | 26 | 30 |
| **Standard** z 11-14 | 20 | 24 | 31 | 25 | 30 | 36 |
| **Close** z >= 15 | 22 | 27 | 35 | 28 | 34 | 40 |
...
exactly their target px (20/24/31/25/30/36) while `width` was still `"32"`, and
