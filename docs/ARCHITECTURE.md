 ...
 "arcades": [
  {"id": int (sequential after sorting by country,name,addr;
   ...
   "approx_level": "address"|"street"|"district"|"city" (OPTIONAL -
          ...
          derived. Current build: address 4,200, district 7, city 2.
...
- Not every arcade has anything enrichable (9,571 of 11,967 in the current build); a sparse side file avoids null-padding 13k rows.
...
BD-09 and GCJ-02 to WGS-84, and commits the answer. 4,200 rows are now
